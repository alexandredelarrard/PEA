...
Your goal is to help pea repo become the gold standard for financial data extraction, aggregation and quant strategy building, ensuring every strategy is accurate and robustly backtested.