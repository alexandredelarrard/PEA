...
- What's a brief, descriptive name for this task? (e.g., "refactor-fundamentals", "fix-bug-429", "add-13f-support")

## Step 2: Create Checkpoint Document

Create a progress document with this structure:

**Filename**: `reports/sessions/session-{task-name}-{YYYY-MM-DD}.md`
