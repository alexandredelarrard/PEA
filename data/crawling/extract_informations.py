        ...
        if len(news_driver) == 1:
            ...
            for news in news_items:
                ...
                if len(split) == 3:
                    ...
                    news_infos.append({"TITLE" : "", "SUMMARY" : news, "DATE" : ""})
...
def save_to_disk(company, results, save_path):
    ...
    for key in ["income-statement-annual", "balance-sheet-annual", "cash-flow-annual"]:
...
def extract_infos(driver, sub_loc):
    ...
    save_to_disk(company,  {"pricing_infos" : pricing_infos_dict, 
                       ...
                       "kpi_infos" : kpi_infos,
                       "financials_infos" : financials_infos}, sub_loc)
