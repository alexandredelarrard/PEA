...
def test_allocation_backtest_sane():
    ...
    pam = al.per_asset_metrics(rets, cash)
...
def test_regime_tilt_lifts_offensive_budget():
    ...
    off = ("equity", "energy")
    b_hi = rp.tilted_budget(cols, score=0.9, offensive=off, off_range=(0.15, 0.85))
    b_lo = rp.tilted_budget(cols, score=0.1, offensive=off, off_range=(0.15, 0.85))
