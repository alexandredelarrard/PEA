...
-- [extract] fundamentals_facts  (pk: ticker, accession_number, field, fiscal_year, fiscal_period, duration_type; from live DB)
...
-- SKIPPED (source missing): notes_embedding <- notes_embedding.parquet
...
-- [extract] sec13f_hr  (pk: cik, period, ticker, cusip; from live DB)
...
-- [extract] earnings_call_sentiment  (pk: ticker, quarter, tag; from live DB)
...
-- [extract] sec_8k  (pk: ticker, accession_number; from live DB)
...
-- [extract] sec_13d  (pk: ticker, accession_number, rp_seq; from live DB)
...
-- SKIPPED (source missing): cube_signal <- output/cube_signal.parquet

-- SKIPPED (source missing): predictions <- output/predictions.parquet

-- SKIPPED (source missing): trend_asset_returns <- output/trend_asset_returns.parquet

-- SKIPPED (source missing): predictions_latest <- output/predictions_latest.parquet

-- SKIPPED (source missing): strategy <- output/strategy.parquet
