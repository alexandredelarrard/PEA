...
CONFIG_KWARGS = dict(default=DEFAULT_CONFIG_DIR, show_default=True, help="Path to the OmegaConf configs directory.")

# optional comma-separated ticker subset; default = the full universe from `sp500_tickers`
TICKERS_ARGS = ("-t", "--tickers")
TICKERS_KWARGS = dict(default=None, help="Comma-separated ticker subset (default: full sp500_tickers universe).")
