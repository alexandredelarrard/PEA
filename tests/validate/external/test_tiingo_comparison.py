"""
Tests for src/validate/external/tiingo_comparison.py: Tiingo dataCode kind-dispatch
(flow/flow_abs/instant/latest_q), bucket classification, the ratio-outlier
check (reusing outliers.detect_level_outliers on the our/Tiingo ratio
...
from src.validate.external import tiingo_comparison as tc
