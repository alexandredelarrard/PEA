...
add(
    "earnings_yield",
    "value",
    "TTM net income / market cap (E/P), masked to profitable names only.",
...
add(
    "loss_intensity",
    "value",
    "The annual LOSS as a positive share of market cap: -netIncome / mcap, defined only where TTM net income is negative.",
...
add(
    "book_yield",
    "value",
    "Positive stockholders' equity / market cap (B/P).",
...
add(
    "fcf_yield",
    "value",
    "Positive TTM free cash flow (OCF - capex) / market cap.",
...
add(
    "ebitda_to_ev",
    "value",
    "Positive TTM EBITDA / enterprise value -- the capital-structure-neutral cheapness measure.",
...
add(
    "fcf_to_ev",
    "value",
    "Positive TTM free cash flow / enterprise value.",
...
add(
    "eps_yield",
    "value",
    "Reported DILUTED EPS / price -- E/P net of preferred and after dilution.",
...
add(
    "intrinsic_yield",
    "value",
    "Two-stage DCF on TTM free cash flow / price -- an intrinsic-value-to-price yield.",
...
add(
    "pegy",
    "value",
    "Trailing P/E divided by (EPS growth% + dividend yield%) -- growth- and income-adjusted P/E.",
...
add(
    "ffo_yield",
    "value",
    "REIT funds-from-operations (net income + D&A) / market cap, GICS-scoped to equity REITs.",
...
add(
    ...
    "Same source discipline as `grossMargins`.",
...
add(
    "gross_profitability",
    "quality",
    "Novy-Marx: gross profit / total assets (ex-lease asset base).",
...
add(
    "piotroski_f_score",
    "quality",
    "0-9 count of fundamental-health binaries (profitability, leverage/liquidity, efficiency).",
...
add(
    "rule_of_40",
    "quality",
    "TTM revenue-growth% + FCF-margin% -- the software rule of thumb.",
...
add(
    "asset_growth",
    "quality",
    "YoY growth of the ex-lease total asset base (Fama-French CMA).",
...
add(
    "altman_z",
    "distress",
    "Altman Z (market-value variant): 1.2 WC/TA + 1.4 RE/TA + 3.3 EBIT/TA + 0.6 mcap/TL + 1.0 Sales/TA.",
...
add(
    ...
    "distress",
    "Operating income / |interest expense| -- the stricter, EBIT-based coverage.",
...
add(
    ...
    "distress",
    "Cash / total debt.",
    "Defined wherever both legs exist.",
    "Above 1 is a net-cash balance sheet; near 0 is a fully-drawn borrower.",
)
add(
    "refinancing_risk",
    "distress",
    "Short-term debt / (cash + positive trailing free cash flow).",
...
add(
    "y_earnings_growth",
    "growth",
    "TTM net income vs TTM one year ago, fiscal series.",
    "As above.",
...
add(
    "q_earnings_growth",
    "growth",
    "Latest-quarter net income YoY.",
    "As above, on `netIncome_q`.",
    "Very wide tails around loss-to-profit quarters; the peer-z clip and winsorization bound them.",
)
add(
    "rev_growth_accel",
    "growth",
    "Latest-quarter YoY growth minus the previous quarter's YoY growth.",
    "The quarterly acceleration term.",
    "Symmetric; the extremes are single-quarter inflections.",
)
add(
    "q_margin_vs_ttm",
    "growth",
    "Latest-quarter net margin minus the TTM net margin -- margin inflection.",
...
add(
    "y_margin_vs_ttm",
    "growth",
    "YoY change in the TTM profit margin.",
    "A `diff`, not a `pct` -- a margin is already a ratio.",
...
add(
    ...
    "growth",
    "Operating margin now vs ~5 trading years ago (percentage points).",
...
add(
    "fcf_growth",
    "growth",
    "YoY growth in free cash flow, fiscal series.",
    "Standard YoY on a well-covered column.",
...
add(
    "hyper_growth",
    "growth",
    "0/1 flag: YoY revenue growth above 25%. Emitted RAW, not peer-standardised.",
...
add(
    "shares_growth",
    "capital_allocation",
    "YoY change in shares outstanding (net of buybacks and issuance).",
...
add(
    ...
    "capital_allocation",
    "YoY change in the fully-diluted share count.",
    "Catches dilution the basic count hides.",
    "Positive tail is convertible/option-heavy capital structures.",
)
add(
    "option_overhang",
    "capital_allocation",
    "(Diluted - basic shares) / basic, computed by the extractor on periods where BOTH counts are reported.",
...
add(
    "sbc_intensity",
    "capital_allocation",
    "Stock-based compensation / revenue -- the GROSS equity give-away.",
...
add(
    "sbc_to_ocf",
    "capital_allocation",
    "SBC / operating cash flow -- how much reported operating cash is really non-cash comp.",
...
add(
    "sbc_to_buyback",
    "capital_allocation",
    "SBC / gross buyback magnitude. Above 1 = the repurchase is mopping up option dilution, not returning capital.",
...
add(
    ...
    "capital_allocation",
    "|Net cash paid for acquisitions| / ex-lease assets.",
...
add(
    "intangibles_growth",
    "ma_digestion",
    "YoY growth in the acquired-intangibles balance -- the balance-sheet trace of M&A.",
...
add(
    ...
    "ma_digestion",
    "NOPAT / invested capital, with acquired intangibles INCLUDED in the capital base.",
...
add(
    ...
    "ma_digestion",
    "`roic_incl_intangibles - roic_ex_intangibles`: how much acquired intangibles dilute returns.",
...
add(
    ...
    "ma_digestion",
    "Acquired intangibles / ex-lease total assets.",
    "A balance-sheet weight, not a flow.",
    "Above ~0.5 means most of the balance sheet is purchase accounting -- the writedown exposure.",
)
add(
    "intangibles_to_equity",
    "ma_digestion",
    "Acquired intangibles / positive book equity.",
...
add(
    "dso_change",
    "accounting_quality",
    "YoY change in DSO (days).",
    "A difference, so it is unit-preserving.",
    "The positive tail is receivables growing faster than sales -- revenue recognised ahead of collection.",
)
add(
    "dpo",
    "accounting_quality",
    "Days payable outstanding: payables / COGS x 365.",
    "Same ownership discipline as DSO.",
...
add(
    ...
    "accounting_quality",
    "DSO + DIO - DPO: days of cash tied up in working capital.",
...
add(
    "accruals_ratio",
    "accounting_quality",
    "(Net income - operating cash flow) / assets -- Sloan accruals on the asset base.",
...
add(
    "da_minus_capex_growth",
    "reinvestment",
    "D&A growth minus capex growth (YoY).",
...
add(
    "capex_to_dep",
    "reinvestment",
    "Capex / D&A -- the maintenance-vs-growth capex split.",
...
add(
    "reinvestment_rate",
    "reinvestment",
    "(Capex - D&A + dNWC) / NOPAT -- net cash ploughed back per dollar of after-tax operating profit.",
...
add(
    "asset_turnover",
    "quality",
    "Revenue / AVERAGE total assets (mean of current and 1y-prior, falling back to period-end).",
...
add(
    "gmroi",
    "quality",
    "Gross profit / average inventory -- gross margin return on inventory investment (retail).",
...
add(
    ...
    "quality",
    "(Gross profit - EBITDA) / revenue -- overhead intensity.",
...
add(
    "effective_tax_rate",
    "quality",
    "Income tax expense / pretax income -- the RAW, unclipped, un-defaulted ratio.",
...
add(
    "operating_leverage",
    "operating",
    "Revenue growth minus SG&A growth.",
...
add(
    "margin_expansion_delta",
    "operating",
    "(1y change in gross margin) - (1y change in EBITDA margin).",
...
add(
    ...
    "workforce",
    "YoY growth in revenue per employee -- productivity trend.",
...
add(
    ...
    "pension_risk",
    "Plan assets / projected benefit obligation, from the Financial-Statement-and-NOTES footnote tags.",
...
add(
    ...
    "pension_risk",
    "The coalesced recognised net pension/OPEB deficit level.",
...
add(
    ...
    "pension_risk",
    "The coalesced net deficit / market cap.",
...
add(
    "dividend_yield",
    "shareholder_return",
    "TTM dividends per share / price, RECONCILED against the SEC cash-flow `dividendsPaid` total.",
...
add(
    ...
    "Per-share history first, cash-flow total as fallback.",
...
add(
    ...
    "shareholder_return",
    "Total dividends / positive net income.",
...
add(
    "payout_ratio",
    "shareholder_return",
    "TOTAL shareholder payout (dividends + buybacks) / net income.",
...
add(
    "buyback_intensity",
    "shareholder_return",
    "Gross buyback magnitude / revenue.",
...
add(
    "dps_growth",
    "shareholder_return",
    "YoY growth in declared dividends per share.",
...
add(
    ...
    "growth",
    "ROE x retention ratio -- the maximum growth fundable without new equity or leverage.",
...
add(
    "bank_roa",
    "bank",
    "Net income / assets, GICS-gated to banks.",
...
add(
    "book_value_growth",
    "financials",
    "YoY growth in book equity, GICS-gated to Financials.",
...
add(
    "aoci_to_equity",
    "financials",
    "Accumulated other comprehensive income / equity, GICS-gated to Financials. Signed.",
...
add(
    "ffo_margin",
    "reit_health",
    "FFO / revenue, GICS-gated to equity REITs.",
...
add(
    "ffo_payout",
    "reit_health",
    "Dividends / FFO -- the REIT payout ratio.",
...
add(
    "affo_margin",
    "reit_health",
    "AFFO (FFO - recurring capex) / revenue.",
...
add(
    ...
    "reit_health",
    "AFFO / dividends -- does cash after maintenance capex cover the distribution?",
...
add(
    "ddna_intensity",
    "energy_health",
    "D&A / revenue, GICS-gated to Energy -- depletion intensity.",
...
add(
    "ebitda_margin",
    "energy_health",
    "(Operating income + D&A) / revenue, GICS-gated to Energy.",
...
add(
    "capex_to_rate_base",
    "utilities",
    "Capex / assets, GICS-gated to Utilities -- a rate-base growth proxy.",
...
add(
    "rd_capitalized_roic",
    "ai_capability",
    "ROIC with R&D treated as a 5-year intangible (Damodaran capitalisation) rather than expensed.",
...
add(
    "fwd_eps_yield",
    "expectations",
    "Next-quarter consensus EPS / price.",
...
add(
    "eps_surprise_last",
    "eps_beat",
    "Most recent quarter's EPS surprise (actual vs estimate).",
...
add(
    "eps_surprise_4q_avg",
    "eps_beat",
    "Average EPS surprise over the last four quarters.",
...
add(
    "days_since_earnings",
    "expectations",
    "Calendar days since the most recent PAST earnings report, clipped to [0, 180].",
...
add(
    "profitable",
    "state",
    "0/1 flag: TTM net income > 0. Emitted RAW.",
...
add(
    "fcf_positive",
    "state",
    "0/1 flag: TTM free cash flow > 0. Emitted RAW.",
    "Same NaN discipline.",
...
add(
    "negative_equity",
    "state",
    "0/1 flag: stockholders' equity <= 0. Emitted RAW.",
    "Same NaN discipline.",
...
from scripts.cube_institutionals_catalogue import INSTITUTIONALS  # noqa: E402

CATALOGUES: dict[str, dict[str, tuple[str, str, str, str]]] = {
    "cube_part_fundamentals": CATALOGUE,
    "cube_part_governance": GOVERNANCE,
    "cube_part_institutionals": INSTITUTIONALS,
}
