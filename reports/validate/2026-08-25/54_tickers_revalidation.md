...
**run_id `8090b885946f`** | 54 ticker(s) | tiers 1,2,3 | fields all

12769 finding(s) | 2332 cluster(s) | 55 field family(ies)

severity: critical=7  high=7785  medium=2620  info=2357
...
> **/!\ THE RANKINGS BELOW MAY BE INFLATED.** 1 check(s) fired ABOVE their own declared ceiling (`coverage_field`).
>
...
|---|---|---|---|---|---|---|---|---|
| `adjustment_unguarded` | 1 | facts | 316,116 | 0 | 1138 | 0.00% | 100.0% | ok |
...
| `code_vocabulary` | 1 | history | 75,696 | 0 | 0 | 0.00% | 0.0% | ok |
...
| `dimensional_scope` | 1 | facts | 251,245 | 0 | 0 | 0.00% | 0.0% | ok |
...
| `impossible_value` | 1 | facts | 251,245 | 1 | 0 | 0.00% | 1.0% | ok |
...
| `basis_step` | 2 | facts | 29,566 | 43 | 0 | 0.15% | 2.0% | ok |
| `level_outlier` | 2 | facts | 29,566 | 1549 | 0 | 5.24% | 6.0% | ok |
| `peer_ratio` | 2 | facts | 83,417 | 1982 | 0 | 2.38% | 3.0% | ok |
| `peer_ratio_abstentions` | 2 | facts | 8 | 0 | 6 | 0.00% | 100.0% | ok |
| `scale` | 2 | facts | 29,566 | 445 | 0 | 1.51% | 2.0% | ok |
| `series_shape` | 2 | facts | 5,616 | 924 | 699 | 16.45% | 18.0% | ok |
| `tag_switch_break` | 2 | facts | 29,566 | 68 | 0 | 0.23% | 2.0% | ok |
| `trend_break` | 2 | facts | 29,566 | 1539 | 0 | 5.21% | 6.0% | ok |
| `annual_footing` | 3 | facts | 11,778 | 178 | 0 | 1.51% | 2.0% | ok |
| `cross_vintage` | 3 | facts | 251,245 | 2469 | 0 | 0.98% | 6.0% | ok |
| `derived_vs_asreported` | 3 | facts | 20,834 | 0 | 0 | 0.00% | 5.0% | ok |
| `duplicate_fact` | 3 | facts | 251,245 | 0 | 0 | 0.00% | 1.0% | ok |
| `holdout_q4` | 3 | facts | 11,778 | 222 | 0 | 1.88% | 2.0% | ok |
| `leaf_vs_total` | 3 | facts | 251,245 | 22 | 0 | 0.01% | 25.0% | ok |
| `q4_footing` | 3 | facts | 11,778 | 190 | 0 | 1.61% | 2.0% | ok |
...
- **3 cluster(s) SETTLED** -- a recorded fix measurably reduced them and nothing unwaived is left:
    ...
    - `2603621e89ab` **(clean)** -- extraction, the filer stamps its full-year us-gaap:Revenues into a 91-day fourth-quarter context, and _drop_note_only_quarter could not see it because _lone_quarters dated a quarter only by a covering annual window of THE SAME FIELD -- Revenues has none in those three 10-Ks, so the guard returned before reading a row. It now falls back to the FILING's own annual windows, which the same filings declare across their other fields., `83deeb0` (47 -> 0 queue finding(s))
...
| `netIncome` | 4,488 | 754 | 53 | 53 of 54 tickers | **likely-check-or-catalogue** |
| `pretaxIncome` | 4,157 | 741 | 53 | 53 of 54 tickers | **likely-check-or-catalogue** |
| `basicShares` | 3,186 | 725 | 53 | 53 of 54 tickers | **likely-check-or-catalogue** |
| `dilutedShares` | 3,108 | 707 | 52 | 52 of 54 tickers | **likely-check-or-catalogue** |
| `operatingIncome` | 2,734 | 524 | 44 | 44 of 54 tickers | **likely-check-or-catalogue** |
| `interestExpense` | 2,612 | 505 | 53 | 53 of 54 tickers | **likely-check-or-catalogue** |
| `operatingCashFlow` | 2,074 | 451 | 54 | 54 of 54 tickers | **likely-check-or-catalogue** |
| `depAmort` | 1,485 | 440 | 54 | 54 of 54 tickers | **likely-check-or-catalogue** |
...
| `capex` | 1,132 | 375 | 54 | 54 of 54 tickers | **likely-check-or-catalogue** |
| `totalAssets` | 1,130 | 271 | 54 | 54 of 54 tickers | **likely-check-or-catalogue** |
| `stockBasedComp` | 1,095 | 273 | 54 | 54 of 54 tickers | **likely-check-or-catalogue** |
...
| `grossProfit` | 902 | 179 | 33 | 33 of 54 tickers | **likely-check-or-catalogue** |
| `longTermDebt` | 753 | 285 | 52 | 52 of 54 tickers | **likely-check-or-catalogue** |
| `costOfRevenue` | 728 | 153 | 43 | 43 of 54 tickers | **likely-check-or-catalogue** |
| `shortTermInvestments` | 720 | 167 | 45 | 45 of 54 tickers | **likely-check-or-catalogue** |
| `netInterestIncome` | 694 | 186 | 54 | 54 of 54 tickers | **likely-check-or-catalogue** |
...
| `sellingGeneralAdmin` | 591 | 172 | 37 | 37 of 54 tickers | **likely-check-or-catalogue** |
| `researchAndDevelopment` | 500 | 245 | 54 | 54 of 54 tickers | **likely-check-or-catalogue** |
...
| `noninterestIncome` | 392 | 90 | 8 | 8 of 54 tickers | **likely-filer** |
...
| `restrictedCash` | 340 | 168 | 53 | 53 of 54 tickers | **likely-check-or-catalogue** |
...
| `accountsReceivable` | 306 | 123 | 37 | 37 of 54 tickers | **likely-check-or-catalogue** |
...
| `sharesOutstanding` | 234 | 116 | 54 | 54 of 54 tickers | **likely-check-or-catalogue** |
...
| 2 | `02926a01f9dd` **<-- B's menu** | APA | `pretaxIncome` | 338 | 47 | 6 | high | likely-check-or-catalogue |
| 3 | `9d0ebfbe91bb` **<-- B's menu** | C | `interestExpense` | 335 | 39 | 7 | high | likely-check-or-catalogue |
| 4 | `b09464043fc1` **<-- B's menu** | APA | `operatingIncome` | 320 | 46 | 6 | high | likely-check-or-catalogue |
| 5 | `0b47bf08db6e` **<-- B's menu** | AMT | `depAmort` | 318 | 51 | 4 | high | likely-check-or-catalogue |
| 6 | `5e4107839207` | UNP | `ppeNet` | 318 | 63 | 3 | high | likely-check-or-catalogue |
| 7 | `2943d47a9b6b` | BA | `operatingIncome` | 315 | 44 | 7 | high | likely-check-or-catalogue |
| 8 | `423bbd467f07` | MET | `incomeTaxExpense` | 310 | 44 | 6 | high | likely-check-or-catalogue |
| 9 | `f38ec1daf240` | MCD | `dilutedShares` | 310 | 57 | 7 | high | likely-check-or-catalogue |
| 10 | `3073bffe9c3f` | HCA | `minorityInterest` | 305 | 62 | 2 | high | likely-check-or-catalogue |
| 11 | `18a8dd2430be` | MCD | `basicShares` | 305 | 56 | 7 | high | likely-check-or-catalogue |
...
| 22 | `d7c1802a4e98` | MSFT | `netIncome` | 245 | 30 | 7 | high | likely-check-or-catalogue |
...
| 25 | `5dcc2a60db55` | BAC | `pretaxIncome` | 235 | 35 | 7 | high | likely-check-or-catalogue |
...
- seen in 4 comparable run(s), 2026-08-24 -> 2026-08-25
...
### 2. APA `pretaxIncome` -- `02926a01f9dd`  **<-- B's menu**
...
- checks agreeing: `peer_ratio`x21, `trend_break`x6, `cross_vintage`x5, `level_outlier`x4, `basis_step`x1, `catalogue_exclusion_cost`x1, `series_shape`x1
- severity: high=34, medium=4, info=1 | tier: T1=1, T2=33, T3=5
- periods: 2010-09-30..2024-09-30
- routing: **likely-check-or-catalogue** (53 of 54 tickers on this field)
...
### 4. APA `operatingIncome` -- `b09464043fc1`  **<-- B's menu**
...
### 5. AMT `depAmort` -- `0b47bf08db6e`  **<-- B's menu**

- **score 318** from 51 finding(s) across 4 check(s)
- checks agreeing: `peer_ratio`x39, `level_outlier`x6, `cross_vintage`x5, `series_shape`x1
- severity: high=45, medium=6 | tier: T2=46, T3=5
- periods: 2010-09-30..2026-06-30
- routing: **likely-check-or-catalogue** (54 of 54 tickers on this field)
- *4 INDEPENDENT checks agree here. That is a far stronger prior than one check firing 51 times.*
- seen in 4 comparable run(s), 2026-08-24 -> 2026-08-25
...
- severity: high=53, info=10 | tier: T1=9, T2=54
- periods: 2010-12-31..2024-09-30
- routing: **likely-check-or-catalogue** (51 of 54 tickers on this field)
- *3 INDEPENDENT checks agree here. That is a far stronger prior than one check firing 63 times.*
- seen in 4 comparable run(s), 2026-08-24 -> 2026-08-25
...
- **score 315** from 44 finding(s) across 7 check(s)
- checks agreeing: `trend_break`x19, `level_outlier`x11, `cross_vintage`x5, `scale`x5, `holdout_q4`x2, `annual_footing`x1, `q4_footing`x1
- severity: high=28, medium=16 | tier: T2=35, T3=9
- periods: 2011-12-31..2026-06-30
- routing: **likely-check-or-catalogue** (44 of 54 tickers on this field)
- *7 INDEPENDENT checks agree here. That is a far stronger prior than one check firing 44 times.*
- seen in 4 comparable run(s), 2026-08-24 -> 2026-08-25
- https://www.sec.gov/Archives/edgar/data/12927/000001292721000094/0000012927-21-000094-index.htm
- _a flat 3x rule, because for a lumpy field the MAD is wide enough that a real 3x jump scores under 3.5_

### 8. MET `incomeTaxExpense` -- `423bbd467f07`
...
### 9. MCD `dilutedShares` -- `f38ec1daf240`
...
### 10. HCA `minorityInterest` -- `3073bffe9c3f`
...
### 11. MCD `basicShares` -- `18a8dd2430be`
...
- severity: high=23, medium=3, info=53 | tier: T1=52, T2=24, T3=3
- periods: 2011-03-31..2026-03-31
- routing: **likely-check-or-catalogue** (54 of 54 tickers on this field)
- *9 INDEPENDENT checks agree here. That is a far stronger prior than one check firing 79 times.*
- seen in 4 comparable run(s), 2026-08-24 -> 2026-08-25
...
- severity: high=22, medium=17, info=8 | tier: T1=8, T2=36, T3=3
- periods: 2011-01-30..2026-04-26
- routing: **likely-check-or-catalogue** (53 of 54 tickers on this field)
- *6 INDEPENDENT checks agree here. That is a far stronger prior than one check firing 47 times.*
- seen in 4 comparable run(s), 2026-08-24 -> 2026-08-25
...
### 22. MSFT `netIncome` -- `d7c1802a4e98`

- **score 245** from 30 finding(s) across 7 check(s)
- checks agreeing: `peer_ratio`x16, `cross_vintage`x7, `trend_break`x3, `annual_footing`x1, `holdout_q4`x1, `q4_footing`x1, `scale`x1
- severity: high=29, medium=1 | tier: T2=20, T3=10
- periods: 2010-09-30..2023-09-30
- routing: **likely-check-or-catalogue** (53 of 54 tickers on this field)
- *7 INDEPENDENT checks agree here. That is a far stronger prior than one check firing 30 times.*
- seen in 4 comparable run(s), 2026-08-24 -> 2026-08-25
...
### 25. BAC `pretaxIncome` -- `5dcc2a60db55`
...
| `2603621e89ab` |  | `` | extraction | the filer stamps its full-year us-gaap:Revenues into a 91-day fourth-quarter context, and _drop_note_only_quarter could not see it because _lone_quarters dated a quarter only by a covering annual window of THE SAME FIELD -- Revenues has none in those three 10-Ks, so the guard returned before reading a row. It now falls back to the FILING's own annual windows, which the same filings declare across their other fields. | 47 -> 0 | `83deeb0` | `tests/data_extract/test_note_only_quarter_2603621e89ab.py` |
