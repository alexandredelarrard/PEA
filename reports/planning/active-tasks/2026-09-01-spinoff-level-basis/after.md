# Spinoff level-basis baseline -- `after`

Generated 2026-09-02 01:35:50Z from the live `pea` database by `scripts/spinoff_level_baseline.py`.
...
A cross-sectional model reads a name's RANK, not its level. Of 37,495 scored rows, **3,371 (8.99%)** change size decile once `S` is applied: **37.02%** of the 3,957 rows with `S != 1`, and 5.68% of the rest (which move only because their peers did).
...
| `cube_part_prices.close_split` | `c069626e806b9337` |
| `cube_part_prices.close_total` | `e64585da69f6ac00` |
| `cube_part_prices.ret` | `59609f221ac7c1f4` |
| `cube_part_prices.volume` | `96639633e582256a` |
